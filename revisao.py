...
def obter_dados():
    ...
    while True:
        ...
        if not nome_roupa == "" or not descricao_roupa == "" or not tamanho == "" or not cor == "" or not valor == "" or quantidade == "":
            print("\nTodos os campos precisam ser preenchidos.\n")
        else:
            data_roupa = {
                "id_roupas": len(db_roupas) + 1,
...
def cadastrar_roupa(receber_roupa):
    ...
    with open(roupas, "w", enconding="utf-8") as arq_json:
